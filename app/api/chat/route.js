...
//     try {
//         // Fetching the most recent reviews from Firebase Firestore
//         const reviewsCollection = collection(db, 'reviews'); // Ensure the collection path is correct
//         const recentQuery = query(reviewsCollection, orderBy('scrapedAt', 'desc'), limit(3)); // Adjust the limit as needed
