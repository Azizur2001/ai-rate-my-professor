...
//     try {
//         console.log(`Fetching URL: ${url} using ScraperAPI`);
...
//         console.log(`Scraped ${reviews.length} reviews and ${ratings.length} ratings`);
...
//         console.log('Review saved to JSON file');
