...
// import { db } from '../../firebase'; // Assuming firebase.js is in /app directory
...
//           console.log('Fetched review:', doc.data()); // Debugging log
...
//         console.log('Checking Review:', review); // Debugging log

//         return (
//           (subject ? review.subject.toLowerCase().includes(subject.toLowerCase()) : true) &&
//           (minRating ? review.stars >= parseFloat(minRating) : true) &&
//           searchCriteria.keywords.every(keyword => review.review.toLowerCase().includes(keyword.toLowerCase()))
//         );
//       });
