  ...
  const handleSearch = () => {
    ...
    const filteredResults = results.filter((review) => {
      return (
        ...
        (keywords.knowledgeable ? review.review.toLowerCase().includes('knowledgeable') : true) &&
        (keywords.engaging ? review.review.toLowerCase().includes('engaging') : true) &&
        (keywords.responsive ? review.review.toLowerCase().includes('responsive') : true) &&
        (keywords.criticalThinking ? review.review.toLowerCase().includes('critical thinking') : true)
      );
    });
